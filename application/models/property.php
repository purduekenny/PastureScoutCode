...
class Property extends CI_Model{
	...
	function get_properties($num=5, $start=0){
		$this->db->select('`id`, `name`, `location`, `region`, `city`, `state`, `country`, `restricted_stock_type`, `max_head_count`, `min_bid`, `opening_bid_date`, `closing_bid_date`,`other_info`');
	...
	function get_properties_by_user($user_id, $num=0, $start=0){
		$this->db->select('`id`, `name`, `location`, `region`, `city`, `state`, `country`, `restricted_stock_type`, `max_head_count`, `min_bid`, `opening_bid_date`, `closing_bid_date`,`other_info`, `user_id`');
