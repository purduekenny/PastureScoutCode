...
class Upload_Forages extends CI_Controller {
    ...
    function __construct() {
        ...
        //Delete img url
        $this->setDelete_img_url(base_url() . 'upload_forages/deleteImage/');
    ...
    public function index($forage_id) {
        ...
        $this->load->view('forages/image_upload', $data);
        $this->load->view('footer/main_view');
    }

    // Function called by the form
    public function upload_img($forage_id) {
       ...
       //Load the upload library
        ...
        if ($this->do_upload()) {
            ...
            $info->delete_url = $this->getDelete_img_url() . $forage_id . '/' . $name;
            $info->delete_type = 'DELETE';


            //upload json to DB
            $this->forage->set_image($forage_id, $name);
           //Return JSON data
    ...
    public function deleteImage($forage_id) {
        ...
        //update db
        $this->forage->update_images($forage_id, $image_string);
    ...
    //Load the files
    public function get_files($forage_id) {
        $this->get_scan_files($forage_id);
    }

    //Get info from db
    public function get_scan_files($forage_id) {
        //get images from db
        $images = $this->forage->get_images($forage_id);
        ...
        foreach ($image_array as $image) {
            ...
            $file->delete_url = $this->getDelete_img_url() . $forage_id . '/' . rawurlencode($file->name);
