...
#wrapper-2 { margin:70px 0 0 0; height:530px; background-image:url('<?= base_url() ?>images/viral/JohnWayne.png'); background-repeat:no-repeat; text-align:left; display:inline-block; }
...
#form a { height:53px; display:block; background-image:url('<?= base_url() ?>images/viral/btn_sprite.png'); }
...
.footer { background-image:url('<?= base_url() ?>images/viral/grass.png'); background-repeat:repeat-x; height:60px; /* .push must be the same height as .footer */ }
...
<div class="wrapper">
	<div id="wrapper-1">
	    <div id="wrapper-2">
			<div id="content">
		    	<img src="<?= base_url() ?>images/viral/main_message.png" alt="Having trouble finding or securing a pasture lease?" />
	            <img class="sub_message" src="<?= base_url() ?>images/viral/sub_message.png" alt="Be part of the next evolution in pasture leasing." />
                
                <?php echo validation_errors("<div class='validation'>","</div>"); ?>
              
              	<div class="success" style="text-align: left;">Congratulations, you've signed up! We'll notify you when we go live.</div>
