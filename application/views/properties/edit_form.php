...
$other_info = array(
    'name'  => 'other_info',
    'id'    => 'other_info',
    'value' => isset($property['other_info']) ? $property['other_info'] : set_value('other_info'),
    'rows'  => 30,
    'cols'  => 30
);
            ...
            <select name="state" id="state">
                ...
                <option value='Alabama' 
                    <?php 
                        ...
                        echo ($property['state']=='Alabama') ? 'selected' : ''; 
                ...
                <option value='Alaska' 
                    <?php 
                        echo ($property['state']=='Alaska') ? 'selected' : ''; 
                ...
                <option value='Arizona' 
                    <?php  
                        echo ($property['state']=='Arizona') ? 'selected' : ''; 
                ...
                <option value='Arkansas' 
                    <?php  
                        echo ($property['state']=='Arkansas') ? 'selected' : ''; 
                ...
                <option value='California' 
                    <?php  
                        echo ($property['state']=='California') ? 'selected' : ''; 
                ...
                <option value='Colorado' 
                    <?php  
                        echo ($property['state']=='Colorado') ? 'selected' : ''; 
                ...
                <option value='Connecticut' 
                    <?php  
                        echo ($property['state']=='Connecticut') ? 'selected' : ''; 
                ...
                <option value='Delaware' 
                    <?php  
                        echo ($property['state']=='Delaware') ? 'selected' : ''; 
                ...
                <option value='District Of Columbia' 
                    <?php  
                        echo ($property['state']=='District Of Columbia') ? 'selected' : ''; 
                ...
                <option value='Florida' 
                    <?php  
                        echo ($property['state']=='Florida') ? 'selected' : ''; 
                ...
                <option value='Georgia' 
                    <?php  
                        echo ($property['state']=='Georgia') ? 'selected' : ''; 
                ...
                <option value='Hawaii' 
                    <?php  
                        echo ($property['state']=='Hawaii') ? 'selected' : ''; 
                ...
                <option value='Idaho' 
                    <?php  
                        echo ($property['state']=='Idaho') ? 'selected' : ''; 
                ...
                <option value='Illinois' 
                    <?php  
                        echo ($property['state']=='Illinois') ? 'selected' : ''; 
                ...
                <option value='Indiana' 
                    <?php  
                        echo ($property['state']=='Indiana') ? 'selected' : ''; 
                ...
                <option value='Iowa' 
                    <?php  
                        echo ($property['state']=='Iowa') ? 'selected' : ''; 
                ...
                <option value='Kansas' 
                    <?php  
                        echo ($property['state']=='Kansas') ? 'selected' : ''; 
                ...
                <option value='Kentucky' 
                    <?php  
                        echo ($property['state']=='Kentucky') ? 'selected' : ''; 
                ...
                <option value='Louisiana' 
                    <?php  
                        echo ($property['state']=='Louisiana') ? 'selected' : ''; 
                ...
                <option value='Maine' 
                    <?php  
                        echo ($property['state']=='Maine') ? 'selected' : ''; 
                ...
                <option value='Maryland' 
                    <?php  
                        echo ($property['state']=='Maryland') ? 'selected' : ''; 
                ...
                <option value='Massachusetts' 
                    <?php  
                        echo ($property['state']=='Massachusetts') ? 'selected' : ''; 
                ...
                <option value='Michigan' 
                    <?php  
                        echo ($property['state']=='Michigan') ? 'selected' : ''; 
                ...
                <option value='Minnesota' 
                    <?php  
                        echo ($property['state']=='Minnesota') ? 'selected' : ''; 
                ...
                <option value='Mississippi' 
                    <?php  
                        echo ($property['state']=='Mississippi') ? 'selected' : ''; 
                ...
                <option value='Missouri' 
                    <?php  
                        echo ($property['state']=='Missouri') ? 'selected' : ''; 
                ...
                <option value='Montana' 
                    <?php  
                        echo ($property['state']=='Montana') ? 'selected' : ''; 
                ...
                <option value='Nebraska' 
                    <?php  
                        echo ($property['state']=='Nebraska') ? 'selected' : ''; 
                ...
                <option value='Nevada' 
                    <?php  
                        echo ($property['state']=='Nevada') ? 'selected' : ''; 
                ...
                <option value='New Hampshire' 
                    <?php  
                        echo ($property['state']=='New Hampshire') ? 'selected' : ''; 
                ...
                <option value='New Jersey' 
                    <?php  
                        echo ($property['state']=='New Jersey') ? 'selected' : ''; 
                ...
                <option value='New Mexico' 
                    <?php  
                        echo ($property['state']=='New Mexico') ? 'selected' : ''; 
                ...
                <option value='New York' 
                    <?php  
                        echo ($property['state']=='New York') ? 'selected' : ''; 
                ...
                <option value='North Carolina' 
                    <?php  
                        echo ($property['state']=='North Carolina') ? 'selected' : ''; 
                ...
                <option value='North Dakota' 
                    <?php  
                        echo ($property['state']=='North Dakota') ? 'selected' : ''; 
                ...
                <option value='Ohio' 
                    <?php  
                        echo ($property['state']=='Ohio') ? 'selected' : ''; 
                ...
                <option value='Oklahoma' 
                    <?php  
                        echo ($property['state']=='Oklahoma') ? 'selected' : ''; 
                ...
                <option value='Oregon' 
                    <?php  
                        echo ($property['state']=='Oregon') ? 'selected' : ''; 
                ...
                <option value='Pennsylvania' 
                    <?php  
                        echo ($property['state']=='Pennsylvania') ? 'selected' : ''; 
                ...
                <option value='Rhode Island' 
                    <?php  
                        echo ($property['state']=='Rhode Island') ? 'selected' : ''; 
                ...
                <option value='South Carolina' 
                    <?php  
                        echo ($property['state']=='South Carolina') ? 'selected' : ''; 
                ...
                <option value='South Dakota' 
                    <?php  
                        echo ($property['state']=='South Dakota') ? 'selected' : ''; 
                ...
                <option value='Tennessee' 
                    <?php  
                        echo ($property['state']=='Tennessee') ? 'selected' : ''; 
                ...
                <option value='Texas' 
                    <?php  
                        echo ($property['state']=='Texas') ? 'selected' : ''; 
                ...
                <option value='Utah' 
                    <?php  
                        echo ($property['state']=='Utah') ? 'selected' : ''; 
                ...
                <option value='Vermont' 
                    <?php  
                        echo ($property['state']=='Vermont') ? 'selected' : ''; 
                ...
                <option value='Virginia' 
                    <?php  
                        echo ($property['state']=='Virginia') ? 'selected' : ''; 
                ...
                <option value='Washington' 
                    <?php  
                        echo ($property['state']=='Washington') ? 'selected' : ''; 
                ...
                <option value='West Virginia' 
                    <?php  
                        echo ($property['state']=='West Virginia') ? 'selected' : ''; 
                ...
                <option value='Wisconsin' 
                    <?php  
                        echo ($property['state']=='Wisconsin') ? 'selected' : ''; 
                ...
                <option value='Wyoming' 
                    <?php  
                        echo ($property['state']=='Wyoming') ? 'selected' : ''; 
