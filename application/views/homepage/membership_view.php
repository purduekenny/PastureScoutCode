<div class="container-fluid">
    <div class="content">
        ...
        <div class="row-fluid">
            ...
            <p><strong>Sign up today to search, save, and bid on leases.</strong></p> 
            </div><!-- end span6 -->
            <div class="span6">
                ...
                <p><strong>Sign up today to list and auction your property.</strong></p> 
            </div><!-- end span6 -->
        </div><!-- end rowfluid -->
        <h1 style="text-align:center">Membership Levels</h1> 
        <div class="row-fluid">
            <div class="span6">
