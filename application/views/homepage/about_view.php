        ...
        <div class="tab-pane active" id="tabs1-pane1">
            <h1>Why is PastureScout needed?</h1>
                ...
                <h2>Leasing pasture is harder than it should be</h2>
                    <p>In the past, finding pasture for lease has been difficult and time-consuming.</p>  

                    <p>For a pasture seeker, information about availability and price is hard to come by, especially if you have to search outside your home region or if you do not regularly lease land.</p>  

                    <p>For a pasture owner, advertising in local newspapers or by word of mouth does not expose you to all eligible leases, decreasing your opportunity to get the optimum price and leasing arrangement.</p>   
